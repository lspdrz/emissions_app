	  ...
	  _createClass(EntryTable, [{
	    ...
	    value: function render() {
	      ...
	      this.props.entries.forEach(function (entry) {
	        ...
	        if (entry.company.indexOf(_this2.props.filterText.toUpperCase()) === -1 || entry.county.indexOf(_this2.props.filterText.toUpperCase()) === -1) {
	          return;
	        }
	...
	var EntryRow = exports.EntryRow = function (_React$Component) {
	  ...
	  _createClass(EntryRow, [{
	    ...
	    value: function render() {
	      ...
	      var county = this.props.entry.county;
	      return _react2.default.createElement(
	        'ul',
	        null,
	        company,
