...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EntryTable = exports.EntryTable = function (_React$Component) {
	  ...
	  _createClass(EntryTable, [{
	    key: 'makeLowerCase',
	    value: function makeLowerCase(e) {
	      var returnString = e;
	      var i = 0;
	      for (i = 0; i < e.length; i++) {
	        returnString[i] = returnString[i] - 97;
	      }
	      return returnString;
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      this.props.entries.forEach(function (entry) {
	        if (entry.company.indexOf(_this2.props.filterText) === -1 || entry.company.indexOf(_this2.makeLowerCase(_this2.props.filterText)) === -1) {
	          return;
	        }
