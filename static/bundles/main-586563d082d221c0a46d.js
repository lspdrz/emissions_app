	...
	var EntriesList = function (_React$Component) {
	  ...
	  _createClass(EntriesList, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(_FilterableEntryTable.FilterableEntryTable, { entries: this.state.data });
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EntryTable = exports.EntryTable = function (_React$Component) {
	  ...
	  _createClass(EntryTable, [{
	    ...
	    value: function handleShowTableChange(showTable) {
	    ...
	    value: function render() {
	      ...
	      this.props.entries.forEach(function (entry) {
	        ...
	        if (rowNames.indexOf(newRow) === -1) {
	          rowNames.push(newRow);
	        }
	        rows.push(_react2.default.createElement(_EntryRow.EntryRow, { entry: entry,
	          key: entry.account,
	          showTable: _this2.state.showTable,
	          onShowTableChange: _this2.handleShowTableChange
	        }));
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        null,
	        rowNames,
	        _react2.default.createElement(_CountyTable.CountyTable, { rows: rows, showTable: this.state.showTable })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CountyTable = exports.CountyTable = function (_React$Component) {
	  ...
	  function CountyTable(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (CountyTable.__proto__ || Object.getPrototypeOf(CountyTable)).call(this, props));

	    _this.handleCountyViewClick = _this.handleCountyViewClick.bind(_this);
	    return _this;
	  }

	  _createClass(CountyTable, [{
	    key: 'showCountyInfo',
	    value: function showCountyInfo(county) {
