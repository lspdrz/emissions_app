...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CountyRow = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./CountyRow\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	  ...
	  _createClass(EntryTable, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        null,
	        rows[0],
	        _react2.default.createElement(_CountyRow.CountyView, { rows: rows })
	      );
	    }
	  }]);
