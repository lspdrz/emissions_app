	  ...
	  _createClass(EntryTable, [{
	    ...
	    value: function render() {
	      ...
	      this.props.entries.forEach(function (entry) {
	        ...
	        if (entry.company.indexOf(_this2.props.filterText.toUpperCase()) === -1) {
	          return;
	        }
	...
	var EntryRow = exports.EntryRow = function (_React$Component) {
	  ...
	  _createClass(EntryRow, [{
	    ...
	    value: function render() {
	      ...
	      var sic_description = this.props.entry.sic_description;
	      return _react2.default.createElement(
	        'ul',
	        null,
	        company,
	        '- ',
	        sic_description.charAt(0) + sic_description.slice(1).toLowerCase()
	      );
	    }
	  }]);
