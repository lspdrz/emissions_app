...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CompanyRow = __webpack_require__(160);
	...
	var EntriesList = function (_React$Component) {
	  ...
	  _createClass(EntriesList, [{
	    ...
	    value: function render() {
	      ...
	      //   })
	      // }
	      return _react2.default.createElement(_CompanyRow.CompanyRow, { data: this.state.data })
	      // <div>
	      //   <h1>All Companies!</h1>
	      //   <ul>
	      //     {entryNodes}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CompanyRow = exports.CompanyRow = function (_React$Component) {
	  _inherits(CompanyRow, _React$Component);

	  function CompanyRow(props) {
	    _classCallCheck(this, CompanyRow);

	    var _this = _possibleConstructorReturn(this, (CompanyRow.__proto__ || Object.getPrototypeOf(CompanyRow)).call(this, props));

	    _this.state = { entries: [] };
	    return _this;
	  }

	  _createClass(CompanyRow, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
