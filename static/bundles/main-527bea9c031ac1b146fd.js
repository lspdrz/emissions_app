	  ...
	  _createClass(EntryTable, [{
	    ...
	    value: function render() {
	      ...
	      this.props.entries.forEach(function (entry) {
	        ...
	        var newRow = _react2.default.createElement(_CountyButton.CountyButton, { onHandleShowTable: _this2.handleShowTable,
	          entry: entry });
	    ...
	    value: function render() {
	      _react2.default.createElement(
	        ...
	        { className: "result-button",
	          onClick: this.handleShowTableChange,
	          key: this.props.entry.county,
	          county: this.props.entry.county },
	        this.props.entry.county
	      );
	    }
	  }]);
