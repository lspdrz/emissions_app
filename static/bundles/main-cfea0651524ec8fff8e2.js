	    ...
	    value: function render() {
	      ...
	      this.props.entries.forEach(function (entry) {
	        if (county === entry.county) {
	          ...
	          num++;
	          co_tpy = co_tpy + Number(entry.co_tpy);
	          nox_tpy += entry.nox_tpy;
	          pb_tpy += entry.pb_tpy;
	          pm_ten_tpy += entry.pm_ten_tpy;
	          so_two_tpy += entry.so_two_tpy;
	          voc_tpy += entry.voc_tpy;
	        }
	      });
