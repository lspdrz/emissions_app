...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _EntryTable = __webpack_require__(162);
	  ...
	  _createClass(FilterableEntryTable, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_EntryTable.EntryTable, { filterText: this.state.filterText,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _EntryRow = __webpack_require__(163);

	var _CountyButtonRows = __webpack_require__(170);

	var _CountyTable = __webpack_require__(164);
	...
	var EntryTable = exports.EntryTable = function (_React$Component) {
	  _inherits(EntryTable, _React$Component);

	  function EntryTable(props) {
	    _classCallCheck(this, EntryTable);

	    var _this = _possibleConstructorReturn(this, (EntryTable.__proto__ || Object.getPrototypeOf(EntryTable)).call(this, props));
	  ...
	  _createClass(EntryTable, [{
	    key: 'handleShowTable',
	    value: function handleShowTable(countyToShow) {
	      this.setState(function (prevState) {
	        return {
	          showTable: !prevState.showTable,
	          countyToShow: countyToShow
	        };
	      });
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_CountyTable.CountyTable, {
	          ...
	          countyToShow: this.state.countyToShow,
	          entries: this.props.entries })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EntryRow = exports.EntryRow = function (_React$Component) {
	  _inherits(EntryRow, _React$Component);

	  function EntryRow(props) {
	    _classCallCheck(this, EntryRow);

	    var _this = _possibleConstructorReturn(this, (EntryRow.__proto__ || Object.getPrototypeOf(EntryRow)).call(this, props));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CountyTable = exports.CountyTable = function (_React$Component) {
	  ...
	  _createClass(CountyTable, [{
	    key: "render",
	    value: function render() {
	      var county = this.props.countyToShow;
	...
	CountyTable.propTypes = {
	  ...
	  entries: _react2.default.PropTypes.array.isRequired,
	  countyToShow: _react2.default.PropTypes.string.isRequired
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".entries-list {\n  postion: absolute;\n  margin: auto;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  width: 100px;\n  height: 100px; }\n\n.search-form {\n  width: 500px;\n  margin: 50px auto; }\n\n.search-bar {\n  padding: 8px 15px;\n  background: rgba(50, 50, 50, 0.2);\n  border: 0px solid #dbdbdb; }\n\n.result-button {\n  position: relative;\n  padding: 6px 15px;\n  bordwer: 2px solid #207cca;\n  background-color: #207cca;\n  color: #fafafa; }\n\n.result-button:hover {\n  background-color: #fafafa;\n  color: #207cca; }\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CountyButtonRows = exports.CountyButtonRows = function (_React$Component) {
	  ...
	  _createClass(CountyButtonRows, [{
	    key: 'handleShowTableChange',
	    value: function handleShowTableChange(e) {
	      this.props.onHandleShowTable(e.target.county);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      this.props.entries.forEach(function (entry) {
	        ...
	        //If the button is not already present, push to array:
	        if (rows.indexOf(newRow.target.county) === -1) {
	          rows.push(newRow);
	        }
	      });
	      return _react2.default.createElement(
