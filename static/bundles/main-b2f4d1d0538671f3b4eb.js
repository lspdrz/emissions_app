	...
	var EntriesList = function (_React$Component) {
	  ...
	  _createClass(EntriesList, [{
	    ...
	    value: function render() {
	      // if (this.state.data) {
	      //   var entryNodes = this.state.data.map(function(entry, i){
	      //     return <li key={i}> {entry.company} </li>
	      //   })
	      // }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FilterableEntryTable = exports.FilterableEntryTable = function (_React$Component) {
	  ...
	  function FilterableEntryTable(props) {
	    ...
	    return _possibleConstructorReturn(this, (FilterableEntryTable.__proto__ || Object.getPrototypeOf(FilterableEntryTable)).call(this, props));
	  }
	  ...
	  _createClass(FilterableEntryTable, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_EntryTable.EntryTable, { entries: this.props.entries })
	      );
	    }
	  }]);
	  ...
	  _createClass(SearchBar, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "form",
	        null,
	        _react2.default.createElement("input", { type: "text", placeholder: "Search for Company" })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EntryRow = exports.EntryRow = function (_React$Component) {
	  ...
	  // componentDidMount() {
	  //   var entryNodes = this.props.data.map(function(entry, i){
	  //     return <li key={i}> {entry.company} </li>
	  //   })
	  //   console.log('was here')
	  //   this.setState({entries: entryNodes});
	...
	EntryRow.propTypes = {
	  entry: _react2.default.PropTypes.array.isRequired
	};
