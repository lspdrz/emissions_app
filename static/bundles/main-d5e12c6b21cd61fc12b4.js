	  ...
	  _createClass(EntryTable, [{
	    ...
	    value: function render() {
	      ...
	      this.props.entries.forEach(function (entry) {
	        //If user input is empty, don't return an entry
	        if (_this2.props.filterText === '') {
	          return;
	        }
	        //Test for upper case user input, since all entries are in upper case
	        else if (entry.county.indexOf(_this2.props.filterText.toUpperCase()) === -1) {
	            return;
	          }
	      ...
	      return _react2.default.createElement(
	        ...
	        rows[0],
	        '// ',
	        _react2.default.createElement(_CountyView.CountyView, { rows: rows })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CountyView = exports.CountyView = function (_React$Component) {
	  ...
	  function CountyView(props) {
	    ...
	    return _possibleConstructorReturn(this, (CountyView.__proto__ || Object.getPrototypeOf(CountyView)).call(this, props));
	  }
